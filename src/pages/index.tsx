  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience the power of video with Tst - your ultimate platform for creating and enjoying YouTube short videos seamlessly."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1611162616475-46b635cb6868?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx5b3V0dWJlfGVufDB8fHx8MTY4OTg4MDI4NHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/es/@alexbemore?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience the power of video with Tst - your ultimate platform for creating and enjoying YouTube short videos seamlessly.`}
            </Text>
            <Box
